...
export class LineService {
    ...
    async verifySignature(request: Request): Promise<boolean> {
        ...
        // We need to clone the request to read the body without consuming it for later use
        // OR the caller should pass the body text. 
        // For simplicity in this architecture, we assume the caller handles the body reading 
        // or we clone it here. Let's clone.
